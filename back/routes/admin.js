...
api.put('/actualizar_producto_admin/:id',auth.auth,AdminController.actualizar_producto_admin);
api.get('/listar_variedades_admin/:id',auth.auth,AdminController.listar_variedades_admin);
api.put('/actualizar_variedad_admin/:id',auth.auth,AdminController.actualizar_variedad_admin);
...
api.put('/agregar_imagen_galeria_admin/:id',auth.auth,AdminController.agregar_imagen_galeria_admin);
...
api.get('/obtener_pago/:id',AdminController.obtener_pago);
