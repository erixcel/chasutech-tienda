...
api.get('/obtener_datos_cliente',clienteController.obtener_datos_cliente);
api.post('/enviar_email',clienteController.enviar_email);
...
api.post('/registro_cliente',auth.auth,clienteController.registro_cliente);
...
api.get('/obtener_direccion_tienda_cliente',auth.auth,clienteController.obtener_direccion_tienda_cliente);
...
api.get('/obtener_orden_cliente/:transaccion_id',auth.auth,clienteController.obtener_orden_cliente);
...
api.post('/create_token',clienteController.create_token);
api.post('/webhook',clienteController.webhook);
