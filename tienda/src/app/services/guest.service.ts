...
export class GuestService {
  ...
  obtener_datos_cliente(token:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
    return this._http.get(this.url + 'obtener_datos_cliente',{headers:headers});
  }

  enviar_email(data:any):Observable<any>{
    let headers = new HttpHeaders().set('Content-Type','application/json');
    return this._http.post(this.url + 'enviar_email',data,{headers:headers});
  }

  registro_cliente_tienda(token:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
    return this._http.post(this.url + 'registro_cliente_tienda',{},{headers:headers});
  }
  ...
  obtener_direccion_tienda_cliente(token:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
    return this._http.get(this.url+'obtener_direccion_tienda_cliente/',{headers:headers});
  }
  ...
  obtener_orden_cliente(transaccion_id:any,token:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
    return this._http.get(this.url+'obtener_orden_cliente/'+transaccion_id,{headers:headers});
  }
  ...
  create_token(data: any): Observable<any> {
    return this._http.post(this.url+'create_token', data);
  }
