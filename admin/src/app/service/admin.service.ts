...
export class AdminService {
  ...
  registro_producto_admin(data:any,file:any,token:any):Observable<any>{
    ...
    fd.append('estrellas',data.estrellas);
  ...
  actualizar_variedad_admin(data:any,id:any,token:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
    return this._http.put(this.url+'actualizar_variedad_admin/'+id,data,{headers:headers});
  }
  ...
  obtener_pago(id:any):Observable<any>{
    let headers = new HttpHeaders()
    return this._http.get(this.url+'obtener_pago/'+id,{headers:headers});
  }
